var store = [{
        ...
        "excerpt":"  이번주는 커뮤니케이션 관련하여 2가지 이슈가 있었습니다. 한 번은 팀 회의를 하면서 서로의 커뮤니케이션을 보면서 느꼈던 점과 다른 한 번은 클라이언트와 화상회의를 하면서 느꼈던 점들을 기록해보고자 합니다. 테마를 정해보자면 다음과 같이 정리할 수 있을 것 같습니다. 효율적인 커뮤니케이션 보수적인(&amp;방어적인) 클라이언트 설득하기 1. 효율적인 커뮤니케이션   업무에 있어서 효율적인 커뮤니케이션이란 무엇일까요?...","categories": ["Data"],
        "tags": ["Data","Memoir"],
        ...
        "excerpt":"  안녕하세요. 이번 포스트부터는 LeetCode50 Aggregate Functions 두번째 파트 이어 가겠습니다. 3. Basic Aggregate Functions 3.5 Queries Quality and Percentage 3.5.1 Table Description &amp; Question Table description table: Queries Colum Name Type query_name varchar result varchar position int rating int There is no primary key for this table, it may...","categories": ["Data"],
        "tags": ["Data","SQL","LeetCode"],
        ...
        "excerpt":"이번 포스트는 파이썬을 사용하면서 알아두면 좋은 용어들을 정리한 포스트입니다. 아래 키워드를 사용해 검색해 보시면 됩니다. 프로그래밍 언어, 인터프리터, 리터럴, 키워드, 객체, 값, 인스턴스, 아이디, 아이템, 가변, 불변, 인덱스, 키, 해시, 컨테이너, 시퀀스, 매칭, 집합, 이중 밑줄 메소드, 모듈, 패키지, 호출 가능 객체, 문, 표현식, 블록, 절, 바디, 변수, 속성, 함수,...","categories": ["Python"],
        "tags": ["Python","Coding","Review"],
        ...
        "tags": ["Computer","Server","IT"],
        "url": "/server/server_basic1/",
        "teaser": null
      },{
        "title": "[서버] 네트워크 관련 기초 지식에 대해 알아보자 (1/2)",
        "excerpt":"데이터 분석가는 데이터 분석만 알고 잘하면 끝인 줄 알았는데 그게 아니더군요. 기초적인 컴퓨터 공학, IT 지식은 갖춰야 한다는 것을 뼈저리게 느꼈습니다. 다양한 분야에 대한 지식이 필요하겠지만 우선 네트워크에 대해서 공부해보고자 합니다.   서버와 클라이언트 간에는 네트워크를 통해서 필요한 데이터를 서로 주고받습니다. 따라시 이번 포스트에서는 네트워크 관련 기초 지식에 대해 정리해보고자...","categories": ["Server"],
